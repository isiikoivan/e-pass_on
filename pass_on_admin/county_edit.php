                                                ...
                                                <div class="col-6  ">
                                                    <form action="" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input value="<?= $dataling['county_id'] ?>" required type="text" class="form-control" id="recipient-name" name="group_id" hidden>
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input required type="text" class="form-control" name="district" value="<?= $dataling['district_district_id'] ?>" hidden>
                                                        </div>

                                                        <div class="mb-3">
                                                            <label for="recipient-name" class="col-form-label">Group Name:</label>
                                                            <input required type="text" class="form-control" name="countyname" value="<?= $dataling['county_name'] ?>">
                                                        </div>
                                                        ...
                                                        <div class="divider">
                                                            <div class="row">
                                                                ...
                                                                <div class="col">
                                                                    <button type="submit" name="update_county" class="btn btn-primary">Update</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </form>
