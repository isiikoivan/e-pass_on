                                                ...
                                                <div class="col-8  ">
                                                    <form action="" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input required type="text" class="form-control" name="parish" value="<?= $dataling['parish_parish_id'] ?>" hidden>
                                                        </div>

                                                        <div class="mb-3">
                                                            <label for="recipient-name" class="col-form-label">Parish Name:</label>
                                                            <input type="text" class="form-control" id="recipient-name" name="villagename" value="<?= $dataling['village_name'] ?>">
                                                        </div>
                                                        ...
                                                        <div class="divider">
                                                            <div class="row">
                                                                ...
                                                                <div class="col">
                                                                    <button type="submit" name="update_village" class="btn btn-primary">Update</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </form>
