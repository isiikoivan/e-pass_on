<nav class="sb-topnav navbar navbar-expand" style="background-color: #064E05;">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3 text-white" >E-PASS ON SYSTEM</a>
            <!-- Sidebar Toggle-->
            ...
            <form class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0">
                <!-- <div class="input-group">
                    ...
                    <button class="btn " style="background-color:#E0F5DF;" id="btnNavbarSearch" type="button"><i class="fas fa-search"></i></button>
                </div> -->
            </form>
            <!-- Navbar-->
