...

{
  ...
  {
    echo 'cow';
    $sql = "SELECT farmer.farmer_id,farmer.farmer_first_name,farmer_group.group_id,farmer_group.group_name
    FROM farmer 
  ...
  {
    /////////////////////////////////////////////////////////////////////////////////////////////////////
    $sql = "SELECT  district.district_name,county.county_name,sub_county.sub_county_name,parish.parish_name,
    village.village_name,farmer_group.group_name FROM farmer_group INNER JOIN
    village ON farmer_group.village_village_id =village.village_id INNER JOIN parish ON village.parish_parish_id =parish.parish_id INNER JOIN  sub_county ON sub_county.county_county_id =county.county_id INNER JOIN county ON county.district_district_id = district.district_id;
";
   ...
   $stmt->execute();
    ...
    // echo 'rabiit';
    // /////////////////////////////////////////////////////////////////////////////////////////////////////
    // $sql =  "SELECT d.district_name, c.county_name, sc.sub_county_name
    // FROM district AS d, county AS c,sub_county AS sc
    ...
    // $GLOBALS['datas'] = $exe->fetchAll(PDO::FETCH_ASSOC);
    // // print_r($data);
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////
    // $sql="SELECT * FROM farmer where farmer_id in (select group_id FROM farmer_group)";
    // $stmt = $pdo->prepare($sql);
    // //$stmt->execute();
    // $sql = "SELECT w.farmer_name
    // FROM farmer AS w
    //     INNER JOIN farmer_group AS g ON w.farmer_group_group_id = g.group_id";
...
//     $sql = "SELECT * FROM $table_name WHERE $value =:$values";
//     $stmt = $pdo->prepare($sql);
//     $stmt->execute([$values => $id]);

//     $_SESSION['loc'] = $stmt->fetch(PDO::FETCH_ASSOC);
//     $data = $_SESSION['loc'];
//     return $data;
//   }
...
//     $sql = "SELECT district_name,county_name,
// FROM 
// district d,county c
// WHERE 
// d.district_id = c.district_district_id AND c.county_id = s.county_county_id ";
//     //,sub_county s,parish p,village v,farmer_group fg,farmer f 
//     //sub_county_name,parish_name,village_name,group_name,farmer_first_name,farmer_last_name,farmer_last_others 
//     // AND s.sub_county_id=p.sub_county_sub_county_id AND p.parish_id = v.parish_parish_id AND v.village_id = fg.village_village_id
//     // AND fg.farmer_id = f.farmer_group_group_id
//     $stmt = $pdo->prepare($sql);
//     //$stmt->execute();
//     $exe = $stmt->execute();
//     $data = $exe->fetchAll(PDO::FETCH_ASSOC);
//     $_SESSION['joinone'] =  $data;
//   }
//   //validating text validating all xtics
//   function validating_all($vt_value, $text)
//   {
